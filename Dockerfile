...
COPY --from=frontend-build /app/frontend/dist/poke-api/browser/ ./src/main/resources/static/poke-api/
...
COPY --from=backend-build /app/build/libs/spring-boot-proxy-server-0.0.1-SNAPSHOT.jar app.jar
